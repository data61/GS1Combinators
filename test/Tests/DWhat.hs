...
testMkDWhat = do
  ...
  describe "create valid AggregationDWhat" $
    it "creates AggregationDWhat from valid input" $
      ppDWhat (AggregationDWhat Observe (Just "urn:epc:id:sscc:0614141.1234567890") [EPC "rn:epc:id:sgtin:0614141.107346.2017", EPC "urn:epc:id:sgtin:0614141.107346.2018"] [QuantityElement "urn:epc:idpat:sgtin:4012345.098765.*" (10 :: Double) Nothing, QuantityElement "urn:epc:class:lgtin:4012345.012345.998877" (200.5 :: Double) (Just "KGM")]) `shouldBe` "AGGREGATION WHAT\nObserve\nJust \"urn:epc:id:sscc:0614141.1234567890\"\n[rn:epc:id:sgtin:0614141.107346.2017,urn:epc:id:sgtin:0614141.107346.2018]\n[QuantityElement \"urn:epc:idpat:sgtin:4012345.098765.*\" 10.0 Nothing,QuantityElement \"urn:epc:class:lgtin:4012345.012345.998877\" 200.5 (Just \"KGM\")]"
